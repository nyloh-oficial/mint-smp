...
public final class ShopMenu extends Menu {
    ...
    private void buildCategory() {
        ...
        for (String key : items.getKeys(false)) {
            ...
            if (meta != null) {
                ...
                meta.lore(List.of(
                        Items.noItalic(Msg.mm("<gray>Cost: <gradient:#3DDC84:#A8FF60>" + Amounts.money(cost))),
    ...
    @Override public void onClick(int slot, ClickType click, InventoryClickEvent e) {
        ...
        Msg.sendRaw(player, "<green>Bought <white>" + amount + "x " + niceName(mat.name()) + "</white> for <gradient:#3DDC84:#A8FF60>" + Amounts.money(cost));
    }
