...
public final class Display {
    ...
    public void update(Player p) {
        ...
        lines.add(legacy("<gray>Money: <gradient:#3DDC84:#A8FF60>" + Amounts.money(economy.money(p.getUniqueId()))));
    ...
    public void updateTablist(Player p) {
        ...
        var footer = Msg.mm("<gray>Money: <gradient:#3DDC84:#A8FF60>" + Amounts.money(economy.money(p.getUniqueId()))
