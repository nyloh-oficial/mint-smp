...
public final class Display {
    ...
    public void update(Player p) {
        ...
        lines.add(legacy("<gray>Money: <red>" + Amounts.money(economy.money(p.getUniqueId()))));
        ...
        lines.add(legacy("<dark_gray>\u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500"));
        lines.add(legacy("<#3DDC84>" + plugin.getConfig().getString("general.server-ip", "themintsmp.kinetichosting.gg")));
    ...
    public void updateTablist(Player p) {
        ...
        String ip = plugin.getConfig().getString("general.server-ip", "themintsmp.kinetichosting.gg");
        var header = Msg.mm("<gradient:#3DDC84:#1B5E20><bold>Mint SMP</bold></gradient>\n"
                + "<gray>Online: <white>" + Bukkit.getOnlinePlayers().size());
        var footer = Msg.mm("<gray>Money: <red>" + Amounts.money(economy.money(p.getUniqueId()))
