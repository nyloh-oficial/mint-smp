...
public final class ChatListener implements Listener {
    ...
    public void onChat(AsyncChatEvent e) {
        ...
        // GUI text prompt (AH search, order creation) — consume before anything else.
        if (net.mintsmp.gui.ChatPrompt.isWaiting(p.getUniqueId())) {
            e.setCancelled(true);
            org.bukkit.Bukkit.getScheduler().runTask(plugin, () -> net.mintsmp.gui.ChatPrompt.feed(p, msg));
            return;
        }
