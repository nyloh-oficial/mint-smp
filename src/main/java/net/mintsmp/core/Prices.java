...
public final class Prices {
    ...
    /** Public sellability check (used by the Sell GUI). */
    public boolean canSell(ItemStack it) { return sellable(it); }
    ...
    private boolean sellable(ItemStack it) {
        ...
        if (Items.getString(it, Keys.MYTHIC) != null) return false;
